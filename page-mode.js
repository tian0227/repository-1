(function(){
  ...
  const homeText={
    zh:{title:'旅行目录',sub:'每一天独立成页。旅行当天直接打开对应日期，查时间、地图和预算会更快。',prep:['行程准备','入境要求、TDAC、行李清单与准备进度'],d26:['8月26日','航班 · DMK汇合 · 芭提雅入住 · 海鲜 · 水果'],d27:['8月27日','格兰岛 · 拖曳伞 · 游泳 · 夜钓鱿鱼'],d28:['8月28日','射击 · 骑象 · 前往曼谷 · Jim Thompson House'],d29:['8月29日','泰服 · 郑王庙 · 卧佛寺 · DMK返程'],sum:['金额统计','查看实际消费 THB / JPY 与填写进度']},
    en:{title:'Trip directory',sub:'Each day has its own page for faster access to times, maps and budgets while travelling.',prep:['Trip preparation','Entry rules, TDAC and packing checklist'],d26:['Aug 26','Flights · DMK meet-up · Pattaya · seafood · fruit'],d27:['Aug 27','Koh Larn · parasailing · swimming · squid fishing'],d28:['Aug 28','Shooting · elephant ride · Bangkok · Jim Thompson House'],d29:['Aug 29','Thai costume · Wat Arun · Wat Pho · DMK'],sum:['Expense summary','Actual spending in THB / JPY and entry progress']},
    ja:{title:'旅行メニュー',sub:'日ごとに独立したページです。旅行中はその日のページだけ開けば、時間・地図・予算をすぐ確認できます。',prep:['旅行準備','入国条件・TDAC・持ち物チェック'],d26:['8月26日','フライト · DMK合流 · パタヤ · 海鮮 · フルーツ'],d27:['8月27日','ラン島 · パラセーリング · 海水浴 · イカ釣り'],d28:['8月28日','射撃 · 象乗り · バンコク · Jim Thompson House'],d29:['8月29日','タイ衣装 · ワットアルン · ワットポー · DMK'],sum:['金額集計','実際支出 THB / JPY と入力状況']},
    th:{title:'เมนูทริป',sub:'แยกแต่ละวันเป็นคนละหน้า เพื่อดูเวลา แผนที่ และงบได้เร็วระหว่างเดินทาง',prep:['เตรียมทริป','การเข้าเมือง TDAC และเช็กลิสต์กระเป๋า'],d26:['26 ส.ค.','เที่ยวบิน · พบกันที่ DMK · พัทยา · ซีฟู้ด · ผลไม้'],d27:['27 ส.ค.','เกาะล้าน · พาราเซลลิ่ง · ว่ายน้ำ · ตกหมึก'],d28:['28 ส.ค.','ยิงปืน · ขี่ช้าง · กรุงเทพฯ · Jim Thompson House'],d29:['29 ส.ค.','ชุดไทย · วัดอรุณ · วัดโพธิ์ · DMK'],sum:['สรุปค่าใช้จ่าย','ยอดจริง THB / JPY และความคืบหน้า']}
  };
  function setRoutes(){
  ...
  function renderHome(){
    ...
    h.innerHTML=`<div class="homeintro"><h2>${t.title}</h2><p>${t.sub}</p></div><div class="homegrid">
