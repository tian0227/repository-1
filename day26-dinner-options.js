(function(){
  ...
  const options=[
    {name:'The Glass House Silver',tag:'优先推荐',reason:'顺利到酒店、时间充裕；第一晚想要更好的海边度假氛围。',price:'฿1,000–2,000 · ¥4,800–9,600',route:`https://www.google.com/maps/dir/?api=1&origin=${hotel}&destination=The+Glass+House+Silver+Pattaya&travelmode=driving`,google:'https://www.google.com/maps/search/?api=1&query=The+Glass+House+Silver+Pattaya',menu:'https://www.glasshouse-pattaya.com/en/glasshouse-silver-menu.php'},
    {name:'Moom Aroi Na Kluea',tag:'海鲜优先',reason:'当天特别想认真吃一顿泰式海鲜，虾、蟹、鱼、鱿鱼等选择更丰富。',price:'฿1,200–2,200 · ¥5,760–10,560',route:`https://www.google.com/maps/dir/?api=1&origin=${hotel}&destination=Moom+Aroi+Na+Kluea+Pattaya&travelmode=driving`,google:'https://www.google.com/maps/search/?api=1&query=Moom+Aroi+Na+Kluea+Pattaya',menu:'https://www.google.com/maps/search/?api=1&query=Moom+Aroi+Na+Kluea+Pattaya'},
    {name:'Bamboo Beach',tag:'轻松省时',reason:'有点累但仍想在海边吃；更容易控制用餐时间，方便之后去 Terminal 21。',price:'฿500–1,200 · ¥2,400–5,760',route:`https://www.google.com/maps/dir/?api=1&origin=${hotel}&destination=Bamboo+Beach+Pattaya&travelmode=walking`,google:'https://www.google.com/maps/search/?api=1&query=Bamboo+Beach+Pattaya',menu:'https://www.facebook.com/BambooBeachPattaya/'},
    {name:'Chomtalay',tag:'晚到备用',reason:'堵车、入住较晚或已经很累时直接在酒店吃，尽量保留 Terminal 21 购物时间。',price:'฿1,000–1,800 · ¥4,800–8,640',route:`https://www.google.com/maps/dir/?api=1&origin=${hotel}&destination=Chom+Talay+Restaurant+Garden+Cliff+Pattaya&travelmode=walking`,google:'https://www.google.com/maps/search/?api=1&query=Chom+Talay+Restaurant+Garden+Cliff+Pattaya',menu:'https://gardencliffpattaya.com/restaurant.html'}
  ];
  function addStyle(){if(document.getElementById('d26DinnerStyle'))return;const s=document.createElement('style');s.id='d26DinnerStyle';s.textContent='.d26-dinner-links{margin-top:10px;display:grid;gap:8px}.d26-dinner-row{border:1px solid #dfe8e5;border-radius:12px;padding:9px 10px;background:#fafcfb}.d26-dinner-head{display:flex;justify-content:space-between;gap:10px;align-items:baseline;font-size:11px;font-weight:850;color:#203a36}.d26-dinner-tag{display:inline-block;margin-left:6px;padding:2px 6px;border-radius:999px;background:#eef5f3;color:#0f625a;font-size:9px}.d26-dinner-price{font-size:10px;color:#697873;text-align:right}.d26-dinner-reason{margin-top:5px;font-size:10px;line-height:1.55;color:#53635e}.d26-dinner-actions{display:flex;gap:6px;flex-wrap:wrap;margin-top:7px}.d26-dinner-actions a{display:inline-block;text-decoration:none;border:1px solid #cbdcd7;border-radius:999px;padding:5px 8px;font-size:10px;font-weight:800;color:#0f625a;background:#fff}.d26-dinner-actions a.route{background:#eef7f5;border-color:#b9d7d1}@media(max-width:520px){.d26-dinner-head{display:block}.d26-dinner-price{text-align:left;margin-top:3px}}';document.head.appendChild(s)}
  function patchLinks(){
